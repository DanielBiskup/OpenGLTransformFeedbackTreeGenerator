...
Erlaubt es schnell und einfach einfache Bedienelemente in die eigene OpenGL Anwendung zu integrieren. Sie bietet wie auf dem Folgenden Link zu sehen ist Methoden um sie ganz leicht mit GLFW2, SDL, usw. zu verbinden. \url{}
...
\paragraph{OpenGL Errorbehandlung}
\paragraph{title}
